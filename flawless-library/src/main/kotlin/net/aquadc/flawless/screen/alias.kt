...
typealias SupportFragScreen<ARG, RET, STATE> = Screen<ARG, RET, SupportFragment, ViewGroup, View, STATE>
...
typealias StatelessSupportFragScreen<ARG, RET> = StatelessScreen<ARG, RET, SupportFragment, ViewGroup, View>
...
typealias SupportDialogFragScreen<ARG, RET, STATE> = Screen<ARG, RET, SupportDialogFragment, Context, Dialog, STATE>
...
typealias StatelessSupportDialogFragScreen<ARG, RET> = StatelessScreen<ARG, RET, SupportDialogFragment, Context, Dialog>
...
typealias SupportBottomSheetDialogFragScreen<ARG, RET, STATE> = Screen<ARG, RET, SupportBottomSheetDialogFragment, Context, View, STATE>
...
typealias StatelessSupportBottomSheetDialogFragScreen<ARG, RET> = StatelessScreen<ARG, RET, SupportBottomSheetDialogFragment, Context, View>
